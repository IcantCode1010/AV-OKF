...
import { KnowledgeGraphExplorer } from "@/components/knowledge-explorer/knowledge-explorer";
...
export default async function KnowledgeGraphPage({ params, searchParams }: {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <KnowledgeGraphExplorer browseHref={`/knowledge/${encodeURIComponent(bundle.id)}/browse`} snapshot={snapshot} />
    </div>
  );
}
